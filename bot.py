...
def handle_link(message):
    ...
    try:
        # Шаг 1: Отправляем ссылку в группу (где есть @TopSaverBot)
        bot.send_message(GROUP_ID, url)
        time.sleep(3)
        
        # Шаг 2: Ждём, пока TopSaverBot ответит
        bot.edit_message_text("⏳ Жду ответ от бота-помощника...", message.chat.id, msg.message_id)
        time.sleep(5)
        
        # Шаг 3: Нажимаем 1080p
